...
tap_dance_action_t tap_dance_actions[] = {
    [TD_SQUARE_LEFT] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, td_left_finished, td_left_reset),
    [TD_SQUARE_RIGHT] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, td_right_finished, td_right_reset),
};
 ...
 */
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, TD(TD_SQUARE_LEFT),  TD(TD_SQUARE_RIGHT),  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, KC_HOME, _______, _______, KC_END, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
